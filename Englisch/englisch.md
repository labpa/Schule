...
Grundsätzlich fast alles klein. Satzanfänge Groß. Ich groß schreiben. Eigenname (Orte, Städte, Länder, Meere, Berge, Sprachen, ...)
Sehr wertgeschätzte Persönlichkeiten (z.B. the Pope, God, He bei God, The Queen)

## Imperativ Befehlsform 

Read this book, please.  
Write it down in English, please.   
Do not read this aloud. / Don´t read this aloud (Umgangssprachlich)  
(Do NOT) Do NOT open this Box  
No smoking!  
No parking!  
No loitering!  
No littering!  
No kissing in public!  
No chewing buble-gum!  

### Übersetzungen
1. Nicht dem Sonennlicht aussetzen.  
+ Do not expose to sunlight.
+ Keep away from sunlight
2. Vor anwendung gut schütteln.  
+ Shake well before using. /use /usage
+ Shake well before applying. /application / -tion (-schen)
3. Münzen hier einwerfen.  
+ Insert coin(s) here.
4. Hebel nach rechts drehen und ziehen.  
+ Turn lever (to (the)) right and pull
5. Bitte frei lassen.  
+ ~~Please leave free~~ (Bitte frei lassen/Aus dem Gefängnis lassen)
+ Kepp empty
+ Leave blank
+ Do not fill in/out.
6. Keine Akkus verwenden.  
+ Do not use rechargeable battery.
7. Nur erhitzten, nicht kochen.  
+ ~~Only heat up. Do not cook~~
+ Do not boil.
+ Do not boil, heat up only.
8. Nicht waschen, nur chemisch reinigen.  
+ Do not wash, ~~only clean with chemikals~~ dry clean only.
9. Benutzername und Passwort eingeben.  
+ Enter username ans password. 
10. Nicht Essen, enthält giftige Stoffe.  
+ Do not eat, contains (toxic) poisonous substances/elements/material.
11. Bitte nicht stören.
Please do not disturb.
12. Achtung Fotos, bitte nicht knicken.  
+ Atention: pictures, do not fold/bend.
13. Lass mich in Ruhe  
+ Leave me alone!
+ Don´t bother me!
14. Vorsicht beim einsteigen.  
+ Enter carefully.
+ Mind the gap.
+ Careful when boarding.

## Passive Voice
 I write a letter.


 Partizip Form regelmäßiger Verben:
 * **e** weiches **d**
 > supported    
 > painted  
 > added    
...
Batteries may be ordered.  
This car can be damaged.  
This must have to/ has to be ordered.

### Übersetzungen
1. Kabel sind nicht enthalten.  
+ Cables (are) not included.
2. Die neueste Version des Mediaplayers ist erforderlich.  
+ The latest version of Mediaplayer is required/needed/necessary.
3. Vorgang wird abgebrochen.
+ Prozess (is) canceled/a borted/ aborting/interrupted/terminated
4. Modul darf nur für professionelle Zwecke benutzt werden.  
+ Modul may be used for professional reasons/purposes only.  
+ Must only be used in a professional setting
+ For professional use only
5. Kabel müssen zusätzlich bestellt werden.  
+ Cables have to be ordered extra.
+ Cables must be ordered separately
6. Software CD liegt bei. /ist enthalten  
Software CD included.
7. Updates werden auf anfrage geliefert.
+ Updates can be sent on request.
+ Updates will be sent on request.
+ Updates will delivered on request.
+ Updates to supplied on request.
8. Adapterkarte wird nicht von Statischer aufladung beeinflusst.  
+ Adapter card (is) not affected by static charge.
+ Adapter card is unaffected by static charges.
...
ISTS Grundeinheit mit Deutschem Computer V30122-B175-A191
